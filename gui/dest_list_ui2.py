...
"border-radius:10px;"))
        ...
        QtCore.QObject.connect(self.pushButton_5, QtCore.SIGNAL(_fromUtf8("clicked()")), Form.btn4)
        QtCore.QObject.connect(self.pushButton_4, QtCore.SIGNAL(_fromUtf8("clicked()")), Form.btn3)
        QtCore.QObject.connect(self.pushButton_6, QtCore.SIGNAL(_fromUtf8("clicked()")), Form.btn1)
        QtCore.QObject.connect(self.pushButton_7, QtCore.SIGNAL(_fromUtf8("clicked()")), Form.btn2)
        QtCore.QMetaObject.connectSlotsByName(Form)

    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Form", None))
        self.pushButton.setText(_translate("Form", "Home", None))
        self.pushButton_4.setText(_translate("Form", "305호", None))
        self.pushButton_5.setText(_translate("Form", "307호", None))
        self.pushButton_6.setText(_translate("Form", "301호", None))
        self.pushButton_7.setText(_translate("Form", "303호", None))
